...
$GLOBALS['TL_DCA']['tl_news']['palettes']['default'] .= ',facebookTeaser,addSocial;{text_legend}';
...
(
	array('LwsNews2Facebook\LwsNews2Facebook','socializeNews')
));

array_insert($GLOBALS['TL_DCA']['tl_news']['config']['ondelete_callback'],0,array
(
	array('LwsNews2Facebook\LwsNews2Facebook', 'deleteNews')
));

$GLOBALS['TL_DCA']['tl_news']['list']['sorting']['headerFields'][] ='socialNews';
$GLOBALS['TL_DCA']['tl_news']['list']['sorting']['headerFields'][] ='socialNewsService';

$GLOBALS['TL_DCA']['tl_news']['list']['operations']['socialized'] = array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_news']['socialized'],
				'icon'                => 'system/modules/lwsnews2facebook/html/socialize0.gif',
				'attributes'          => 'onclick="Backend.getScrollOffset();"',
				'button_callback'     => array('LwsNews2Facebook\LwsNews2Facebook', 'iconSocializedNews')
			);
