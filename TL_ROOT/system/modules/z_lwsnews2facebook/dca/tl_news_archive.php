...
$GLOBALS['TL_DCA']['tl_news_archive']['palettes']['default'] = $GLOBALS['TL_DCA']['tl_news_archive']['palettes']['default'] . ';{lws_news2facebook_legend:hide},socialNews, socialNewsService, facebookTeaserLength, defaultPic, stdurl';
...
(
	...
	'inputType'               => 'select',
	'eval'                    => array('mandatory'=>false),
	'foreignKey'              => 'tl_lws_news2facebook.name'
);
...
$GLOBALS['TL_DCA']['tl_news_archive']['fields']['stdurl'] = array
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_news_archive']['stdurl'],
	'inputType'               => 'text',
